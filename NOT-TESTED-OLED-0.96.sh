#!/usr/bin/env bash
#
# install-pocsag.sh  (v4 - complete, with OLED)
# =============================================================================
...
echo "=============================================================="
echo "   POCSAG pager transmitter - complete installer (v4)"
echo "=============================================================="
echo
...
if [[ "$DO_OLED" =~ ^[Yy] ]]; then
  ...
  # Enable the I2C bus (GPIO2=SDA pin3, GPIO3=SCL pin5). $BOOT set in step 3.
